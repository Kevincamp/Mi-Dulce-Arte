...
<!-- Mejorar el texto de la arquitectura escogida e incluir el lenguaje en el que sera desarrollada -->
...
<!-- TODO: Considerar algo de esto para la arquitectura -->
<!-- ## Tecnologías -->
...
* [Producto mínimo viable MVP](./docs/hito1/mvp.md)
